...
const TranscriptEditor: React.FC<TranscriptEditorProps> = ({ transcript, onChange, isLoading }) => {
  ...
  const handleDownload = async () => {
    try {
      ...
      element.style.fontFamily = "var(--font-main), 'Inter', 'Shruti', 'Noto Sans Gujarati', 'Mangal', 'Noto Sans Devanagari', sans-serif";
